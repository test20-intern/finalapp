...
public interface SalesPerformanceRepo extends JpaRepository<SalesPerformance,String> {
    ...
    @Query(nativeQuery = true,value = "EXEC SalesApp_Test_Select_SalesPerformance @GroupCode=:GroupCode,@BranchCode=:BranchCode,@UnitCode=:UnitCode, @agntnum=:agntnum,@userType=:userType")
