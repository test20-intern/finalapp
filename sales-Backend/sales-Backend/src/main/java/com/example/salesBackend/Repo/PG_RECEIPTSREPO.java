...
public interface PG_RECEIPTSREPO extends JpaRepository<PG_RECEIPTS, PG_RECEIPTSId> {
    @Query(nativeQuery = true, value = "EXEC SalesApp_Select_ReceiptsForPolicyNo @POLICY_NO=:POLICY_NO")
    List<Object[]> findReceiptDataByPolicyNo(@Param("POLICY_NO") String POLICY_NO);
